...
WebUI.setText(findTestObject('midtrans/buynow/email'), GlobalVariable.salhemail)
...
WebUI.verifyElementPresent(findTestObject('midtrans/buynow/invalidemailkosong'), 0)

WebUI.takeScreenshotAsCheckpoint('invalidemail')
