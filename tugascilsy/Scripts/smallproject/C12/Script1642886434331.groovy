...
WebUI.click(findTestObject('midtrans/iframe/selectcvv'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementPresent(findTestObject('midtrans/iframe/verifycvvh4'), 0)

WebUI.takeScreenshotAsCheckpoint('radiobutton')
